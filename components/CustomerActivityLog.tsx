...
export default function CustomerActivityLog({ activities }: CustomerActivityLogProps) {
  ...
  return (
    <div className="space-y-4">
      {activities.map((activity) => (
        <div key={activity._id} className="border-l-2 border-primary pl-4">
          <div className="flex items-start gap-2 mb-1">
            <ActivityIcon className="w-4 h-4 text-primary mt-0.5" />
